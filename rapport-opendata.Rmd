...
- Produire des créations à partir de la base de données
- Adapter (modifier, transformer, construire) la base de données
- Faire un usage commercial

Tant qu’il :
Mentionne la paternité et la date de dernière mise à jour
...
Tant qu’il :
Mentionne la paternité
Partage aux conditions identiques
Garde ouverte la base de données

> **Aller plus loin :** le guide de l'INRA dans sa fiche numéro 6
