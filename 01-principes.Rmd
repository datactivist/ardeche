...
Tim Berners-Lee demande alors au public de la conférence TED de crier « *Raw data now!* » ("Des données brutes maintenant !") à l’attention des administrations.
```{r echo=FALSE, fig.path='raw',out.width='70%', fig.align = 'center', fig.cap='Tim Berners-Lee, lors de sa conférence TED de 2009, Tim Berners-Lee appelle le public à crier « *raw data now* »'}
knitr::include_graphics(rep('./img/raw.png'))
```
